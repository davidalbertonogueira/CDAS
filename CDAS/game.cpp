...
void Game::loadTextures() {
  texmgr.loadTexture("grass", "../CDAS/media/grass.png");
  texmgr.loadTexture("forest", "../CDAS/media/forest.png");
  texmgr.loadTexture("water", "../CDAS/media/water.png");
  texmgr.loadTexture("residential", "../CDAS/media/residential.png");
  texmgr.loadTexture("commercial", "../CDAS/media/commercial.png");
  texmgr.loadTexture("industrial", "../CDAS/media/industrial.png");
  texmgr.loadTexture("road", "../CDAS/media/road.png");

  texmgr.loadTexture("background", "../CDAS/media/background.png");
}
